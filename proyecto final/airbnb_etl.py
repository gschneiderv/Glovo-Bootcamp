...
df_madrid = df.filter(["Host Total Listing", "Street", "Neighbourhood Group Cleansed","City", "State", "Zipcode", "Smart Location","Country Code","Latitude", "Longitude", "Property Type", "Room Type","Accommodates", "Bathrooms", "Bedrooms", "Beds", "Bed Type", "Amenities","Square Feet", "Price", "Security Deposit", "Cleaning Fee", "Guests Included", "Extra People", "Minimum Nights", "Maximum Nights", "Number of Reviews", "Review Scores Rating", "Cancellation Policy", "Reviews per Month"],axis=1)
